...
const PortfolioApp = (() => {
    ...
    const projects = [
        {
            ...
            description:
                "This is a Discord bot that makes it possible to monitor the commits of a specified GitHub repository. The bot will post each commit to a specified Discord channel in real time.",
            icon: "fas fa-code",
        },
        {
            name: "Cursor Cloak",
            ...
            description:
                "Cursor Cloak is an innovative C++ application that enhances user experience by cleverly auto-hiding the cursor during idle times. <br><br> It also features a convenient system tray icon for easy termination. <br><br> It showcases strong skills in C++ and Windows-specific APIs.",
        ...
        },
        {
            ...
            description:
                "This is a Discord bot that simulates raising Chao from the Sonic Adventure games. It is a large scoped project that is currently a work in progress.",
            icon: "fas fa-gamepad",
        },
        {
            name: "Amazon Bot",
    ...
    const populateProjects = () => {
        ...
        const duplicatedProjectsContainer = document.getElementById(
            "duplicated-projects"
        );
    ...
    const handleContactClick = () => {
        document
            ...
            .addEventListener("click", function (event) {
                ...
                document
                    .getElementById("duplicated-projects")
                    .classList.toggle("fade-out");
                document.getElementById("contact-info").classList.toggle("hidden");
